...
ubcf_test_recommendations <- data.frame(VisitorId = character(length = nrow(getData(train_scheme, "unknown"))),
...
for(i in 1:nrow(getData(train_scheme, "unknown"))) {
  ubcf_test_recommendations$VisitorId[i] <- dimnames(getData(train_scheme, "unknown"))[[1]][i]
  ubcf_test_recommendations$rec1[i]  <- ubcf_predictions@items[[i]][1]
  ubcf_test_recommendations$rec2[i]  <- ubcf_predictions@items[[i]][2]
  ubcf_test_recommendations$rec3[i]  <- ubcf_predictions@items[[i]][3]
  ubcf_test_recommendations$rec4[i]  <- ubcf_predictions@items[[i]][4]
  ubcf_test_recommendations$rec5[i]  <- ubcf_predictions@items[[i]][5]
  ubcf_test_recommendations$rec6[i]  <- ubcf_predictions@items[[i]][6]
  ubcf_test_recommendations$rec7[i]  <- ubcf_predictions@items[[i]][7]
  ubcf_test_recommendations$rec8[i]  <- ubcf_predictions@items[[i]][8]
  ubcf_test_recommendations$rec9[i]  <- ubcf_predictions@items[[i]][9]
  ubcf_test_recommendations$rec10[i] <- ubcf_predictions@items[[i]][10]
  ubcf_test_recommendations$rec11[i] <- ubcf_predictions@items[[i]][11]
  ubcf_test_recommendations$rec12[i] <- ubcf_predictions@items[[i]][12]
  ubcf_test_recommendations$rec13[i] <- ubcf_predictions@items[[i]][13]
  ubcf_test_recommendations$rec14[i] <- ubcf_predictions@items[[i]][14]
  ubcf_test_recommendations$rec15[i] <- ubcf_predictions@items[[i]][15]
  ubcf_test_recommendations$rec16[i] <- ubcf_predictions@items[[i]][16]
  ubcf_test_recommendations$rec17[i] <- ubcf_predictions@items[[i]][17]
  ubcf_test_recommendations$rec18[i] <- ubcf_predictions@items[[i]][18]
  ubcf_test_recommendations$rec19[i] <- ubcf_predictions@items[[i]][19]
  ubcf_test_recommendations$rec20[i] <- ubcf_predictions@items[[i]][20]
  ubcf_test_recommendations$rating1[i] <- ubcf_predictions@ratings[[i]][1]
  ubcf_test_recommendations$rating2[i] <- ubcf_predictions@ratings[[i]][2]
  ubcf_test_recommendations$rating3[i] <- ubcf_predictions@ratings[[i]][3]
  ubcf_test_recommendations$rating4[i] <- ubcf_predictions@ratings[[i]][4]
  ubcf_test_recommendations$rating5[i] <- ubcf_predictions@ratings[[i]][5]
  ubcf_test_recommendations$rating6[i] <- ubcf_predictions@ratings[[i]][6]
  ubcf_test_recommendations$rating7[i] <- ubcf_predictions@ratings[[i]][7]
  ubcf_test_recommendations$rating8[i] <- ubcf_predictions@ratings[[i]][8]
  ubcf_test_recommendations$rating9[i] <- ubcf_predictions@ratings[[i]][9]
  ubcf_test_recommendations$rating10[i] <- ubcf_predictions@ratings[[i]][10]
  ubcf_test_recommendations$rating11[i] <- ubcf_predictions@ratings[[i]][11]
  ubcf_test_recommendations$rating12[i] <- ubcf_predictions@ratings[[i]][12]
  ubcf_test_recommendations$rating13[i] <- ubcf_predictions@ratings[[i]][13]
  ubcf_test_recommendations$rating14[i] <- ubcf_predictions@ratings[[i]][14]
  ubcf_test_recommendations$rating15[i] <- ubcf_predictions@ratings[[i]][15]
  ubcf_test_recommendations$rating16[i] <- ubcf_predictions@ratings[[i]][16]
  ubcf_test_recommendations$rating17[i] <- ubcf_predictions@ratings[[i]][17]
  ubcf_test_recommendations$rating18[i] <- ubcf_predictions@ratings[[i]][18]
  ubcf_test_recommendations$rating19[i] <- ubcf_predictions@ratings[[i]][19]
  ubcf_test_recommendations$rating20[i] <- ubcf_predictions@ratings[[i]][20]
}
...
item_labels <- as.character(ubcf_predictions@itemLabels)
...
top20_rec_tidy <- ubcf_test_recommendations %>% 
...
top20_ratings_tidy <- ubcf_test_recommendations %>% 
...
user1_predicted_items <- ubcf_predictions@items[[1]]
user1_predicted_items <- ubcf_predictions@itemLabels[user1_predicted_items]
user1_predicted_items
user1_predicted_ratings <- ubcf_predictions@ratings[[1]]
...
test_recommendations_final <- test_recommendations %>%
  ...
  select(-i, -j)
s3save(test_recommendations_final, bucket = "pred498finalmodel", object = "ubcf_test_recommendations_final.Rdata")
...
test_recommendations_performance <- test_recommendations_final %>%
  ...
  ungroup() %>%
  arrange(desc(TP))
s3save(test_recommendations_performance, bucket = "pred498finalmodel", object = "ubcf_test_recommendations_performance.Rdata")
